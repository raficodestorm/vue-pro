      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
          <ul class="navbar-nav align-items-lg-center">
            ...
            <li class="nav-item">
              <router-link class="nav-link" to="/book-ticket">Book Ticket</router-link>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><router-link class="dropdown-item" to="/routes">Bus Routes</router-link></li>
                <li><router-link class="dropdown-item" to="/offers">Offers</router-link></li>
                ...
                <li class="dropdown-submenu">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><router-link class="dropdown-item" to="/live-chat">Live Chat</router-link></li>
                  </ul>
                </li>
              </ul>
            </li>
            ...
            <li v-if="user" class="nav-item dropdown user-dropdown ms-lg-3">
              ...
              >
                <img
                  ...
                  style="border-radius: 50%; border: 1px solid gray; width: 35px; height: 35px;"
                />
                {{ user.fullname }}
              </a>
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li><router-link class="dropdown-item" to="/profile/edit">Edit Profile</router-link></li>
            ...
            <li v-else class="nav-item dropdown user-dropdown ms-lg-3">
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li><hr class="dropdown-divider" /></li>
                <li>
                  <a class="dropdown-item text-danger" href="javascript:void(0)" @click="openLogin">
                    Login
                  </a>
                </li>
              </ul>
